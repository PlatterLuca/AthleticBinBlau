...
export default function Team() {
  ...
  return (
    <>
      ...
      <main className="bg-cover py-24 px-6 md:px-20">
        <h2 className="text-5xl font-bold text-center mb-12"></h2>
        ...
        <section className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-y-10 gap-x-4 place-items-center">
          {players.map((player, index) => (
            <div key={index} className="team-member text-center">
              {/* Card wrapper — thinner on mobile, thicker from md up */}
              <div className="relative z-0 w-[160px] sm:w-[200px] md:w-[260px] 
                ...
                {showNames && (
                  <div className="absolute bottom-0 w-full z-10
                                  ...
                                  text-sm sm:text-base font-bold text-center
